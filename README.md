...
> **참고:** Steinegger 교수는 독일에서 학사·석사·박사 학위를 취득한 후, 미국 Johns Hopkins University에서 박사후연구원 과정을 거쳐 **2020년 서울대학교 조교수로 임용**
...
## 4. FoldMason 성과와 연구비 지원의 연계성

### 4.1 공식 지원 사업 (보도자료 기준)

과기정통부 보도자료(2026.01.30)에 명시된 지원 사업:
> "과기정통부 '기초연구 사업'과 '합성생물학 기술 개발사업'의 지원으로 수행"

### 4.2 핵심 기여 과제 분석

#### ① 본인 주관 과제 (PI) — 핵심 지원

**[과제 1] 단백질 상호작용체 연구 (2024~2027)**

| 항목 | 내용 |
|------|------|
| **과제명** | 단백질 상호작용체의 구조 수준 규명을 위한 AI 기반 정밀·고속 구조 예측 및 분류 기법 연구 |
| **사업명** | 개인기초연구(과기정통부) | **핵심연구: 우수연구-글로벌 매칭형(독일)**
| **과제번호** | 2710092525 |
| **연구기간** | 2024.12 ~ 2027.11 (3년) |
| **총 연구비** | **450,000천원 (약 4.5억원)** |

→ 단백질 상호작용 네트워크의 구조 수준 분석  
→ 2026년 기초연구사업 체계(개인연구: 신진연구 → 핵심연구 → 리더연구) 내에서, [과제 2] 신진연구 사업이후, **핵심연구 단계로 연구를 지속하는** 것으로 해석됨 (연구자 경력발전 경로)

**[과제 2] FoldU (2021~2026) — FoldMason의 직접적 기반**

| 항목 | 내용 |
|------|------|
| **과제명** | FoldU: 머신러닝을 사용한 메타유전체 스케일 대규모 단백질 폴딩 |
| **사업명** | 개인기초연구(과기정통부) > **신진연구: 신진연구자지원사업** |
| **과제번호** | 2710082001 |
| **연구기간** | 2021.03 ~ 2026.02 (5년) |
| **총 연구비** | **728,581천원 (약 7.3억원)** |

→ FoldMason의 핵심 알고리즘(구조 정렬, 다중 서열 분석) 개발

> **PI 과제 합계: 약 11.8억원**

#### ② 공동연구 참여 과제 — 기술 연계 (추정)

| 과제명 | PI | 사업명 | 기간 | Steinegger 역할 (추정) |
|--------|-----|--------|------|------------------------|
| **인공지능과 물리화학을 결합한 인실리코 단백질 설계** | 석차옥 (서울대 화학부) | 바이오의료기술개발 > 원천기술개발 | 2020~2024 | AI 기반 단백질 구조 예측 모델 개발 협력 (추정) |
| **고해상도 입체 구조 해석을 위한 Cryo-EM/ET 이미징 연계 기술개발연구** | 노성훈 (서울대 생명과학부) | 바이오의료기술개발 > 원천기술개발 | 2021~2025 | 구조 데이터 분석 및 정렬 알고리즘 제공 (추정) |

> ※ 참여연구원으로서의 구체적 역할은 KRI 데이터에서 확인 불가. 과제 내용과 Steinegger 연구 분야(단백질 구조 분석/AI)를 기반으로 추정함.
...
```
석차옥 교수 (서울대 화학부)
    └── 인실리코 단백질 설계 과제 (2020~2024)
         └── Steinegger 참여연구원

노성훈 교수 (서울대 생명과학부)
    └── Cryo-EM/ET 기술개발 과제 (2021~2025)
         └── Steinegger 참여연구원
```
